...
class VistaReviews(Frame):
    def __init__(self, master=None, controlador=None):
        ...
        self.review.grid()
        self.escribirReview = Text(self, height= 5, width=60, bg="Yellow")
        ...
        self.verReviews= Listbox(self, selectmode=SINGLE,bg="Yellow", font=("OpenSans"), fg="Black", height=10, width=60)
